...
public class Empleado extends Persona
{
    ...
    public Empleado(long p_cuil, String p_apellido, String p_nombre, double p_importe, int p_anio, int p_dni, Calendar fechaNacimiento){
        super(p_dni, p_nombre, p_apellido, fechaNacimiento);
        this.setCuil(p_cuil);
    ...
    public Empleado(long p_cuil, String p_apellido, String p_nombre, double p_importe, Calendar p_fecha, Calendar fechaNacimiento, int p_dni){
        super(p_dni, p_nombre, p_apellido, fechaNacimiento);
        this.setCuil(p_cuil);
        this.setSueldoBasico(p_importe);
    ...
    public int antiguedad(){
        ...
        return anioHoy - this.getFechaIngreso().YEAR ;
    }
